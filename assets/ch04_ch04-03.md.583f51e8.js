...
</pre></div></div></section></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-gY5yO" id="tab-fCRnGvo" checked="checked"><label for="tab-fCRnGvo">models.py</label><input type="radio" name="group-gY5yO" id="tab-X8VcQjc"><label for="tab-X8VcQjc">admins.py</label></div><div class="blocks"><div class="language-py vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> django.db </span><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> models</span></span>
<span class="line"></span>
...
</pre></div></div></section></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-iODxn" id="tab-JdsjVnO" checked="checked"><label for="tab-JdsjVnO">config/urls.py</label><input type="radio" name="group-iODxn" id="tab-Mwu7c8N"><label for="tab-Mwu7c8N">polls/urls.py</label></div><div class="blocks"><div class="language-py vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> django.contrib </span><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> admin</span></span>
...
</pre></div></div></section></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-poA_K" id="tab-xvtiG8v" checked="checked"><label for="tab-xvtiG8v">index.html</label></div><div class="blocks"><div class="language-html vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">{% if latest_question_list %}</span></span>
...
$/home/hyungsik74/pycharm/polls-project/polls&gt; cd templates/polls
$/home/hyungsik74/pycharm/polls-project/polls/templates/polls&gt; vi index.html
</pre></div></div></section></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-vcxbg" id="tab-7_58TW9" checked="checked"><label for="tab-7_58TW9">detail.html</label></div><div class="blocks"><div class="language-html vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">h1</span><span style="color:#E1E4E8;">&gt;{{ question.question_text }}&lt;/</span><span style="color:#85E89D;">h1</span><span style="color:#E1E4E8;">&gt;</span></span>
<span class="line"></span>
...
$/home/hyungsik74/pycharm/polls-project/polls&gt; cd templates/polls
$/home/hyungsik74/pycharm/polls-project/polls/templates/polls&gt; vi index.html
</pre></div></div></section></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-PK-WJ" id="tab-QXoYupk" checked="checked"><label for="tab-QXoYupk">results.html</label></div><div class="blocks"><div class="language-html vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">h1</span><span style="color:#E1E4E8;">&gt;{{ question.question_text }}&lt;/</span><span style="color:#85E89D;">h1</span><span style="color:#E1E4E8;">&gt;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">ul</span><span style="color:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="color:#E1E4E8;">{% for choice in question.choice_set.all %}</span></span>
...
</pre></div></div></section></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-Uq07G" id="tab-DlbA6wB" checked="checked"><label for="tab-DlbA6wB">#index</label><input type="radio" name="group-Uq07G" id="tab-GwjnW-F"><label for="tab-GwjnW-F">#detail</label><input type="radio" name="group-Uq07G" id="tab-t42Juiu"><label for="tab-t42Juiu">#vote</label><input type="radio" name="group-Uq07G" id="tab-dZzps3a"><label for="tab-dZzps3a">#results</label><input type="radio" name="group-Uq07G" id="tab-NfRp21D"><label for="tab-NfRp21D">views.py#all</label></div><div class="blocks"><div class="language-py vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> django.shortcuts </span><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> render</span></span>
<span class="line"></span>
