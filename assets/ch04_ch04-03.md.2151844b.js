...
<span class="line"><span style="color:#24292e;">    └─ manage.py</span></span></code></pre></div><h3 id="프로젝트-설정-파일-settings-py-추가" tabindex="-1">프로젝트 설정 파일(settings.py) 추가 <a class="header-anchor" href="#프로젝트-설정-파일-settings-py-추가" aria-label="Permalink to &quot;프로젝트 설정 파일(settings.py) 추가&quot;">​</a></h3><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-__sFP" id="tab-PJqOgu2" checked="checked"><label for="tab-PJqOgu2">polls-project/config/settings.py</label></div><div class="blocks"><div class="language-py vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># Application definition</span></span>
...
<span class="line"><span style="color:#24292E;">]</span></span></code></pre></div></div></div><h2 id="_4-3-3-설문조사-데이터모델-생성" tabindex="-1">4.3.3 설문조사 데이터모델 생성 <a class="header-anchor" href="#_4-3-3-설문조사-데이터모델-생성" aria-label="Permalink to &quot;4.3.3 설문조사 데이터모델 생성&quot;">​</a></h2><p>데이터모델 생성은 장고 프레임웍에서 데이터베이스 관련 테이블 등을 생성을 하는 단계입니다. 다음의 순서대로 생성합니다.</p><div class="console-block" id="console-block-2"><input class="c-tab-unix" id="c-tab-2-unix" type="radio" name="console-2" checked=""><label for="c-tab-2-unix" title="Linux/macOS">/</label><input class="c-tab-win" id="c-tab-2-win" type="radio" name="console-2"><label for="c-tab-2-win" title="Windows"></label><section class="c-content-unix" id="c-content-2-unix" style=""><div class="highlight-console notranslate"><div class="highlight"><pre><span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project&gt;</span> cd polls
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls&gt;</span> pwd
/home/hyungsik74/pycharm/polls-project/polls
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls&gt;</span> vi models.py
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls&gt;</span> vi admin.py
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls&gt;</span> cd ..
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project&gt;</span> pwd
/home/hyungsik74/pycharm/polls-project
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project&gt;</span> python manage.py makemigrations polls
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project&gt;</span> python manage.py migrate
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project&gt;</span> python manage.py runserver
</pre></div></div></section><section class="c-content-win" id="c-content-2-win" style=""><div class="highlight"><pre><span class="gp">C:\\hyungsik74\\pycharm\\polls-project&gt;</span> cd polls
<span class="gp">C:\\hyungsik74\\pycharm\\polls-projectpolls&gt;</span> cd 
C:\\hyungsik74\\pycharm\\polls-projectpolls
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls&gt;</span> notepad models.py   // 테이블을 정의함
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls&gt;</span> notepad admin.py   // 관리자화면에 표시
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls&gt;</span> cd ..
C:\\hyungsik74\\pycharm\\polls-project
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project&gt;</span> py manage.py makemigrations polls  // DB 변경사항
<p><span class="gp">C:\\hyungsik74\\pycharm\\polls-project&gt;</span> py manage.py sqlmigrate polls 0001</p>
<p><span class="gp">C:\\hyungsik74\\pycharm\\polls-project&gt;</span> py manage.py migrate   // DB 변경사항 반영
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project&gt;</span> py manage.py runserver   // 실행</p>
</pre></div></section></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-TmUGx" id="tab-JAkXY2C" checked="checked"><label for="tab-JAkXY2C">models.py</label><input type="radio" name="group-TmUGx" id="tab-EF95gpc"><label for="tab-EF95gpc">admins.py</label></div><div class="blocks"><div class="language-py vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> django.db </span><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> models</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292E;">admin.site.register(Choice)</span></span></code></pre></div></div></div><p>지금까지 작성한 내용을 확인하기 위해서, 프로젝트를 실행합니다. 관리자 페이지에 접속하면, 다음과 같이 새로 생성한 2개의 테이블을 확인 할 수 있습니다.</p><p>*Admin (<a href="http://127.0.0.1:8000/admin" target="_blank" rel="noreferrer">http://127.0.0.1:8000/admin</a>) 사이트 로그인 후 첫 페이지</p><p><img src="`+o+`" alt="ch04-03-03-03-01"></p><h2 id="_4-3-4-url-config" tabindex="-1">4.3.4 URL Config <a class="header-anchor" href="#_4-3-4-url-config" aria-label="Permalink to &quot;4.3.4 URL Config&quot;">​</a></h2><p>이전 장에서 처리 흐름에 따라 URL 및 View를 설계했습니다. URL config라 함은 이런 URL 과 뷰를 연결해 주는 작업입니다. 관리자 페이지를 포함해서 5개의 URL 과 뷰가 필요합니다.</p><div class="console-block" id="console-block-4"><input class="c-tab-unix" id="c-tab-4-unix" type="radio" name="console-4" checked=""><label for="c-tab-4-unix" title="Linux/macOS">/</label><input class="c-tab-win" id="c-tab-4-win" type="radio" name="console-4"><label for="c-tab-4-win" title="Windows"></label><section class="c-content-unix" id="c-content-4-unix" style=""><div class="highlight-console notranslate"><div class="highlight"><pre><span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project&gt;</span> cd /home/hyungsik74/pycharm/polls-project/config
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/confing&gt;</span> pwd
/home/hyungsik74/pycharm/polls-project/config
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/config&gt;</span> vi urls.py
<p><span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project&gt;</span> cd /home/hyungsik74/pycharm/polls-project/polls
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls&gt;</span> pwd
/home/hyungsik74/pycharm/polls-project/polls
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls&gt;</span> vi urls.py</p>
</pre></div></div></section><section class="c-content-win" id="c-content-4-win" style=""><div class="highlight"><pre><span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\config&gt;</span> cd 
C:\\hyungsik74\\pycharm\\polls-project\\config
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\config&gt;</span> notepad urls.py
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\config&gt;</span> cd ..\\polls
C:\\hyungsik74\\pycharm\\polls-project\\polls
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls&gt;</span> cd
C:\\hyungsik74\\pycharm\\polls-project\\polls
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls&gt;</span> notepad urls.py
</pre></div></section></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-q_ciu" id="tab-_IzywYf" checked="checked"><label for="tab-_IzywYf">config/urls.py</label><input type="radio" name="group-q_ciu" id="tab-fbn3leJ"><label for="tab-fbn3leJ">polls/urls.py</label></div><div class="blocks"><div class="language-py vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> django.contrib </span><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> admin</span></span>
...
<span class="line"><span style="color:#24292E;">]</span></span></code></pre></div></div></div><h2 id="_4-3-5-tempate" tabindex="-1">4.3.5 Tempate <a class="header-anchor" href="#_4-3-5-tempate" aria-label="Permalink to &quot;4.3.5 Tempate&quot;">​</a></h2><p>이번 장에서는 하면 UI 에 해당하는 템플릿을 작성하겠습니다.</p><ul><li>index.html</li></ul><div class="console-block" id="console-block-5-1"><input class="c-tab-unix" id="c-tab-5-1-unix" type="radio" name="console-5-1" checked=""><label for="c-tab-5-1-unix" title="Linux/macOS">/</label><input class="c-tab-win" id="c-tab-5-1-win" type="radio" name="console-5-1"><label for="c-tab-5-1-win" title="Windows"></label><section class="c-content-unix" id="c-content-5-1-unix" style=""><div class="highlight-console notranslate"><div class="highlight"><pre><span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project&gt;</span> cd /home/hyungsik74/pycharm/polls-project/polls
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls&gt;</span> pwd
/home/hyungsik74/pycharm/polls-project/polls
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls&gt;</span> mkdir templates
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls&gt;</span> mkdir templates/polls
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls&gt;</span> cd templates/polls
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls/templates/polls&gt;</span> vi index.html
</pre></div></div></section><section class="c-content-win" id="c-content-5-1-win" style=""><div class="highlight"><pre><span class="gp">C:\\hyungsik74\\pycharm\\polls-project&gt;</span> cd C:\\hyungsik74\\pycharm\\polls-project\\polls
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls&gt;</span> cd 
C:\\hyungsik74\\pycharm\\polls-project\\polls
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls&gt;</span> mkdir templates
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls&gt;</span> mkdir templates\\polls
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls&gt;</span> cd templates\\polls
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls\\templates\\polls&gt;</span> notepad index.html
</pre></div></section></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-nJAsu" id="tab-7n5e_2M" checked="checked"><label for="tab-7n5e_2M">index.html</label></div><div class="blocks"><div class="language-html vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">{% if latest_question_list %}</span></span>
...
<span class="line"><span style="color:#24292E;">{% endif %}</span></span></code></pre></div></div></div><p>-- detail.html</p><div class="console-block" id="console-block-5-2"><input class="c-tab-unix" id="c-tab-5-2-unix" type="radio" name="console-5-2" checked=""><label for="c-tab-5-2-unix" title="Linux/macOS">/</label><input class="c-tab-win" id="c-tab-5-2-win" type="radio" name="console-5-2"><label for="c-tab-5-2-win" title="Windows"></label><section class="c-content-unix" id="c-content-5-2-unix" style=""><div class="highlight-console notranslate"><div class="highlight"><pre><span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls/templates/polls&gt;</span> pwd
/home/hyungsik74/pycharm/polls-project/polls/templates/polls
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls/templates/polls&gt;</span> vi detail.html
</pre></div></div></section><section class="c-content-win" id="c-content-5-2-win" style=""><div class="highlight"><pre><span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls\\templates\\polls&gt;</span> cd 
C:\\hyungsik74\\pycharm\\polls-project\\polls\\templates\\polls
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls\\templates\\polls&gt;</span> notepad detail.html
</pre></div></section></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-FafdI" id="tab-_jCeGfn" checked="checked"><label for="tab-_jCeGfn">detail.html</label></div><div class="blocks"><div class="language-html vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">h1</span><span style="color:#E1E4E8;">&gt;{{ question.question_text }}&lt;/</span><span style="color:#85E89D;">h1</span><span style="color:#E1E4E8;">&gt;</span></span>
<span class="line"></span>
...
/home/hyungsik74/pycharm/polls-project/polls/templates/polls
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls/templates/polls&gt;</span> vi results.html
</pre></div></div></section><section class="c-content-win" id="c-content-5-3-win" style=""><div class="highlight"><pre><span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\\\polls\\templates\\polls&gt;</span> cd 
C:\\hyungsik74\\pycharm\\polls-project\\\\polls\\templates\\polls
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\\\polls\\templates\\polls&gt;</span> notepad results.html
</pre></div></section></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-nddh8" id="tab-RPspYF5" checked="checked"><label for="tab-RPspYF5">results.html</label></div><div class="blocks"><div class="language-html vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">h1</span><span style="color:#E1E4E8;">&gt;{{ question.question_text }}&lt;/</span><span style="color:#85E89D;">h1</span><span style="color:#E1E4E8;">&gt;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">ul</span><span style="color:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="color:#E1E4E8;">{% for choice in question.choice_set.all %}</span></span>
...
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls&gt;</span> pwd
/home/hyungsik74/pycharm/polls-project/polls
<span class="gp">$</span><span class="gp">/home/hyungsik74/pycharm/polls-project/polls&gt;</span> vi views.py
</pre></div></div></section><section class="c-content-win" id="c-content-6-win" style=""><div class="highlight"><pre><span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\&gt;</span> cd C:\\hyungsik74\\pycharm\\polls-project\\polls
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls&gt;</span> cd 
C:\\hyungsik74\\pycharm\\polls-project\\polls
<span class="gp">C:\\hyungsik74\\pycharm\\polls-project\\polls&gt;</span> notepad views.py
</pre></div></section></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-E53F4" id="tab-8W4L8iV" checked="checked"><label for="tab-8W4L8iV">#index</label><input type="radio" name="group-E53F4" id="tab-wgZNYrP"><label for="tab-wgZNYrP">#detail</label><input type="radio" name="group-E53F4" id="tab-X7QPGoJ"><label for="tab-X7QPGoJ">#vote</label><input type="radio" name="group-E53F4" id="tab-z_XqheT"><label for="tab-z_XqheT">#results</label><input type="radio" name="group-E53F4" id="tab-I77VPS4"><label for="tab-I77VPS4">views.py#all</label></div><div class="blocks"><div class="language-py vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> django.shortcuts </span><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> render</span></span>
<span class="line"></span>
